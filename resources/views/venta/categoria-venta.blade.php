...
@section('title', 'Clasificación de Ventas')
        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Clasificación de Ventas</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                      <div class="alert alert-warning alert-dismissible text-center margin-bottom-1x">
                        ...
                        <a href="ventas-pendientes" class="text-medium">PENDIENTES</a>
                      </div>
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                      ...
                      <i class="fas fa-check-circle"></i>&nbsp;&nbsp;
                        <a href="ventas-terminadas" class="text-medium">ENTREGADOS</a>                                  
                      </div>
                    </div>
                </div>
              </div>
